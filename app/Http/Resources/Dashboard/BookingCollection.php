        ...
        return [
            ...
            'items'     => $this->collection->map(function ($item) {
                ...
                return [
                    ...
                    'provider_name'     => $item->service?->serviceProvider?->user?->name ?? "مقدم محذوف",
                    'provider_rating'     => $item->service?->serviceProvider؟->rating,
                    'client_photo'        => $item->client؟->getFirstMediaUrl('photo'),
                    'client_name'         => $item->client?->user?->name ?? "عميل محذوف",
                    ...
                    'type'                    => ($item->payments?->refunded_amount) ? 'refund' : 'paid',
